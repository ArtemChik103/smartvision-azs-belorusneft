...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (muteBtn) {
        muteBtn.addEventListener('click', () => {
            ...
            if (muteText) muteText.textContent = isMuted ? 'Звук: Выкл' : 'Звук: Вкл';
            muteBtn.classList.toggle('text-zinc-500', isMuted);
            muteBtn.classList.toggle('text-zinc-300', !isMuted);
        });
    }
