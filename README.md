...
### 2. 🛡️ Автоматическая безопасность и защита от обрыва шлангов (E-STOP)
...
* **Фискальные чеки:** Печать электронного чека с QR-кодом СКНО и начислением баллов «Заправка».
